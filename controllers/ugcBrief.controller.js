const Form = require('../models/ugcBrief.model'); // Adjust the path as necessary

// Create a new form
const createForm = async (req, res) => {
    try {
        const { brand, brief, productName, scenario, description, sampleWork, category, website, country } = req.body;
...
const updateForm = async (req, res) => {
    try {
        ...
        const updatedForm = await Form.findByIdAndUpdate(
            id,
            { brand, brief, productName, scenario, description, sampleWork, category, website, country, files: file },
