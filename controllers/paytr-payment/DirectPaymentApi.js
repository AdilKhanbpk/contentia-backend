...
const PaymentApi = asyncHandler(async (req, res) => {
    try {
        ...
        const paytrData = {
            ...
            merchant_ok_url: 'https://contentia-frontend-9fufiq4np-saudkhanbpks-projects.vercel.app//payment/success',
            // merchant_ok_url: 'http://localhost:3000/payment/success',
            merchant_fail_url: 'https://contentia-frontend-9fufiq4np-saudkhanbpks-projects.vercel.app//payment/Failed',
